const pitchedPresetSpliceSection = () => {
    ...
    // pitchedPresetSpliceTest(2,  48, 10, 1*400/m2/P5, 'pitch35', 32);
    ...
    pitchedPresetSpliceTest(48, 48+48, 10, (1/M2)*1*400/m2/P5, 'pitch36', 32);
    pitchedPresetSpliceTest(48, 48+48, 20, (1/M2)*1*400/m2/P5, 'pitch36', 32);
    pitchedPresetSpliceTest(48, 48+48, 5,  (1/M2)*0.5*400/m2/P5, 'pitch36', 32);
    pitchedPresetSpliceTest(48, 48+48, 3,  (1/M2)*2*400/m2/P5, 'pitch36', 32);
    pitchedPresetSpliceTest(48, 48+48, 4,  (1/M2)*2*400/m2/P5, 'pitch36', 32);
    pitchedPresetSpliceTest(48, 48+48, 8,  (1/M2)*1*400/m2/P5, 'pitch36', 32);
